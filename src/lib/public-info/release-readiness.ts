  ...
  return [
    {
      ...
      evidenceCode: "no-auth-mechanism-in-codebase",
    ...
    },
    {
      ...
      evidenceCode: "no-account-concept",
      ownerActionRequired: false,
    },
    {
      id: "sync",
      ...
      evidenceCode: "localstorage-only-no-sync-code",
      ownerActionRequired: false,
    },
    {
      id: "cloud-backup",
      ...
      evidenceCode: "no-server-side-user-db",
      ownerActionRequired: false,
    },
    {
      id: "local-backup",
    ...
    },
    {
      ...
      evidenceCode: "local-dev-server-only",
      ownerActionRequired: false,
    },
    {
      id: "monitoring",
    ...
    },
    {
      ...
      evidenceCode: "no-formal-security-review",
      ownerActionRequired: true,
    },
    {
      id: "operating-cost",
